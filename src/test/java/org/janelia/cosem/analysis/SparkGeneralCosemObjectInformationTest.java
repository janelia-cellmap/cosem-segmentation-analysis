...
public class SparkGeneralCosemObjectInformationTest {
	...
	SparkGeneralCosemObjectInformation.setupSparkAndRunGeneralCosemObjectInformation("shapes_cc", TestHelper.tempN5Locations, "shapes_cc_to_planes_cc", TestHelper.tempFileLocations, true, true);
