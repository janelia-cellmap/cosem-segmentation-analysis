...
public class SparkContactSites {
	...
	SparkCosemHelper.createDatasetUsingTemplateDataset(inputN5Path, organelle, outputN5Path, outputN5DatasetName);
	...
	rdd.foreach(currentBlockInformation -> {
	    ...
	    final RandomAccessibleInterval<UnsignedLongType> segmentedOrganelle = SparkCosemHelper
	...
	SparkCosemHelper.createDatasetUsingTemplateDataset(inputN5Path, organelle, outputN5Path,
	...
	SparkCosemHelper.createDatasetUsingTemplateDataset(inputN5Path, organelle1, outputN5Path, outputN5DatasetName);
	...
	JavaRDD<BlockInformation> javaRDDsets = rdd.map(currentBlockInformation -> {
	    ...
	    RandomAccess<UnsignedLongType> organelle1DataRA = SparkCosemHelper
		    .getOffsetIntervalExtendZeroRA(inputN5Path, organelle1, paddedOffset, paddedDimension);
	    RandomAccess<UnsignedLongType> organelle2DataRA = SparkCosemHelper
		...
		RandomAccess<UnsignedLongType> organelle1ContactBoundaryDataRA = SparkCosemHelper
			.getOffsetIntervalExtendZeroRA(outputN5Path, organelle1ContactBoundaryName, paddedOffset,
				paddedDimension);
		RandomAccess<UnsignedLongType> organelle2ContactBoundaryDataRA = SparkCosemHelper
	...
	JavaRDD<BlockInformation> javaRDDsets = rdd.map(currentBlockInformation -> {
	    ...
	    final RandomAccessibleInterval<UnsignedLongType> organelle1Data = SparkCosemHelper
		    .getOffsetIntervalExtendZeroRAI(inputN5Path, organelle1ContactBoundaryString, offset, dimension);
	    RandomAccess<UnsignedLongType> organelle1DataRA = organelle1Data.randomAccess();

	    final RandomAccess<UnsignedLongType> organelle2DataRA = SparkCosemHelper
