...
public class SparkExtractExpandedSurface {
	...
	SparkCosemHelper.createDatasetUsingTemplateDataset(n5Path, inputDatasetName, n5OutputPath, outputDatasetName, attributes.getDataType());
	...
	rdd.foreach(blockInformation -> {
	    ...
	    RandomAccessibleInterval<T> segmentation = SparkCosemHelper.getOffsetIntervalExtendZeroRAI(n5Path, inputDatasetName, paddedOffset, paddedDimension);
